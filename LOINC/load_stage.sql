...
--Ingestion of new LOINC concept (COVID19 specific)
...
SELECT concept_code_1, concept_code_2, vocabulary_id_1, vocabulary_id_2, relationship_id,
       '1970-01-01' as valid_start_date,
       '2099-12-31' as valid_end_date,
       NULL as invalid_reason
FROM dev_loinc.concept_relationship_manual_covid_preliminary
;

SELECT *
FROM dev_loinc.concept_relationship_manual
;
...
INSERT INTO dev_loinc.loinc_special_use_integration (loinc_num,long_common_name,component,property,time_aspct,system,scale_typ,method_typ,shortname)
